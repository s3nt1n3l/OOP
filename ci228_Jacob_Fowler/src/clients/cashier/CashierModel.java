...
public class CashierModel extends Observable {
	 ...
	 * 
	 * @param mf
	 *            The factory to create the connection objects
	 */
	...
	public void doRemove() {
		...
		try {
			...
			{ // with customer
				...
				theBasket.remove(theProduct); // Removes last product
				theStock.addStock(theProduct.getProductNum(), theProduct.getQuantity()); // Restocks
	...
	/**
	 * ask for update of view called at start of day or after system reset
	 */
